...
are more computationally intensive \cite{00000048}.  In our dataset,
the features are clearly not independent of each other, and the size
of the problem is too large for more computationally intensive
methods.  Furthermore, logistic regression, being a discriminative
training method, does not require modeling the distribution of the
input features.  This is crucial, since our features arise from a
decidedly artificial process and would be difficult to characterize
