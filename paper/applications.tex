...
we are interested in a bug triggered by bad behavior that occurs once
per hundred runs.  If we want to be 90\% confident to have seen
sampled this misbehavior at least once, then we need at least $100 \times
\log{(1-0.90)} / \log{(1-1/1000)} = 230,143$ runs.  While this may
