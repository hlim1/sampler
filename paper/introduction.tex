...
improvements are always limited.  The normal case is that just through
...
\aside{The preceding two paragraphs are somewhat redundant with
  respect to Section~\ref{sec:compression}.  Do we really need both,
  or is there some way these could be coalesced?}
