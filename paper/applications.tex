...
call is sampled on any such run, elimination by \elim{successful
  counterexample} correctly determines that this predicate does not
...
The top ranked predicates seem bizarre at first examination, because the
