...
contributing to the shared data pool.  Thus, addressing these concerns
is both a moral and a practical imperative.
...
If the ultimate use of sampled data is the sort of data mining used in
...
analyses are characterized by a set of \termdef{sufficient
  statistics}: a collection of values which completely characterize
