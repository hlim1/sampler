...
to hold results on a central server for analysis.  For example, if we
wish to keep all results, then the storage requirements for the
...
large, but fixed, set of predicates (see Sections \autoref{sec:ccrypt}
