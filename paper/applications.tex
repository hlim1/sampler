...
to all bugs.  \elim{Elimination by successful counterexample} assumes
...
independent: \elim{universal falsehood} and \elim{lack of failing
  coverage} each eliminate a subset of the counters identified by
...
remain.  \aside{Is this actually true?  It should be.  I've asked
  Alice to check that it is.}  Thus we have the ability to identify
...
explore this idea of broad correlation in Section~\ref{sec:bc}, where
even the buggy line code itself does not always cause a crash.
