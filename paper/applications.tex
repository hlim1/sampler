...
\aside{Stipulate what the performance experiment is: average of 4
  random runs, what kind of machine, etc.  Perhaps say this at the
  first set of performance metrics (\autoref{sec:ccured}) and
  stipulate there that all subsequent performance data is the same.}
