...
\begin{figure}
  \centering
  \includegraphics{applications/perimeter}
  \caption{\texttt{perimeter} tunning times with single-function
    instrumentation}
...
each site-containing function, with sites either checked always or
sampled 1/100.
...
areas for improvement.  Recurring trends we have observed include:
