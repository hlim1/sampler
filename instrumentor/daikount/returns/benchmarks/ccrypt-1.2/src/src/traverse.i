...
# 37 "/usr/include/sys/stat.h" 3
# 1 "/usr/include/time.h" 1 3
# 38 "/usr/include/sys/stat.h" 2 3
# 103 "/usr/include/sys/stat.h" 3
...
# 106 "/usr/include/sys/stat.h" 2 3
# 207 "/usr/include/sys/stat.h" 3
...
void set_attributes(char *filename, struct stat *bufp) {
  struct utimbuf ut = {bufp->st_atim.tv_sec, bufp->st_mtim.tv_sec};
