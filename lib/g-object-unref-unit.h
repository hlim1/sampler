...
static samplerTimestamp gObjectUnrefTimestampsFirst[sizeof(gObjectUnrefCounters) / sizeof(*gObjectUnrefCounters)];
#endif /* SAMPLER_TIMESTAMP_FIRST */

#ifdef SAMPLER_TIMESTAMP_LAST
#pragma cilnoremove("gObjectUnrefTimestampsLast");
static samplerTimestamp gObjectUnrefTimestampsLast[sizeof(gObjectUnrefCounters) / sizeof(*gObjectUnrefCounters)];
