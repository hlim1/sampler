...
main: %: $(libs) $(addsuffix .$(cmo), identity skipVisitor functionBodyVisitor simplifyVisitor simplifyReturns simplifyLefts simplifyRights checkSimplicity instrument utils duplicate transform testHarness %)
	$(link)
