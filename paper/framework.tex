...
\aside{Still need to discuss:

  \begin{itemize}
  \item instrumenting a single function at a time
  \item hierarchical sampling at the level of functions and sites
  \item client-side data reduction
  \end{itemize}}
