...
From these benchmarks and the examples in Sections~\ref{sec:ccrypt} and
~\ref{sec:bc}, we conclude that realistic deployments will use sampling
densities between 1/100 and 1/1000.  But how efficient is 1/1000
sampling at observing rare program behavior?
Suppose we are interested in a bug occurring in $1\%$ of executions.  
To achieve 90\%
confidence of observing this bug in at least one run, we
...
increase the sampling density.  Thus, our techniques are likely
most suited to applications with at least hundreds of thousands of executions
per day.
%The use of statistically fair
...
though in general one might find different results.  \elim{Elimination
