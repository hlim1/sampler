...
\item While our primary interest is in finding and fixing quality
  ...
  to know which features are most commonly used, or we may be interested
  in discovering any code not covered by in-house testing is ever
  executed in practice, etc.
...
(\autoref{sec:framework}) as it is about the 
subsequent data analysis (\autoref{sec:applications}).
...
%
% FIX: We have three applications now.   - Alex
%
