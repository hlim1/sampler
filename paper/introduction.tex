...
information that helps engineers to find and fix problems more
quickly.  In our view, such an infrastructure has several benefits:
\begin{itemize}
...
\item Gathering information from all, or at least a representative
  ...
  affect a great number of users are higher priority than bugs that
