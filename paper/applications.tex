...
\aside{While it is uncommon to do an analysis where the number of
  ...
  \begin{itemize}
  \item 81 samples in 3 classes; 4682 genes \cite{Dudoit:2002:CDM}
  \item 72 samples in 3 classes; 6817 genes \cite{Dudoit:2002:CDM}
  \item 64 samples in 9 classes; 5244 genes \cite{Dudoit:2002:CDM}
