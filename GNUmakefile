...
main: %: $(libs) $(addsuffix .$(cmo), identity skipVisitor functionBodyVisitor currentFunctionVisitor simplifyReturns simplifyLefts simplifyRights checkSimplicity instrument utils duplicate transform testHarness %)
	$(link)
